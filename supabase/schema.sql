-- Full current-state schema snapshot, kept in sync with supabase/migrations/.
-- Not run directly — it's the "what does the live database look like right now"
-- reference. Every migration that changes the schema must update this file in
-- the same commit. See docs/DATABASE.md for the migration process.
--
